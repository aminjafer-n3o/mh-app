          ...
          <>
            <IonContent fullscreen>
              <div className='max-w-800 mx-auto ion-padding flex flex-col gap'>
                ...
                <h2 className="title text-center font-bold">Regular Giving</h2>

                <IonLabel>Loading your regular giving record...</IonLabel>
          ...
          <IonContent>
            <LoginWall>
              <div id='mockup-content' style={{ position: 'relative', zIndex: 0 }} className='ion-padding max-w-800 mx-auto flex flex-col gap'>
                ...
                <h2 className="title text-center font-bold">Regular Giving</h2>
                <p className="paragraph text-center">Login to see your regular giving donations</p>
